...
class InvoiceAutomation:
    def __init__(self, use_gpu=False):
        ...
        try:
            # NER Pipeline
            ner_model_name = "dslim/bert-base-NER"  # Smaller, more efficient model
            ...
            if 'items' in input_data:
                ...
                for item in input_data['items']:
                    processed_item = {
                        ...
                        'category': self.categorize_items(item['description'])
                    }
...
if __name__ == "__main__":
    try:
        ...
        invoice_system = InvoiceAutomation(use_gpu=use_gpu)
        ...
        # Generate invoice
        generated_invoice = invoice_system.generate_invoice(sample_data)
        
        if generated_invoice:
            print("Invoice generated successfully!")
            print(json.dumps(generated_invoice, indent=2))
        else:
